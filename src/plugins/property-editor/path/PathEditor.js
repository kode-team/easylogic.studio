...
import { POINTERSTART, BIND, POINTERMOVE, PREVENT, KEYUP, IF, STOP, DOUBLECLICK, ENTER, ESCAPE, DOUBLETAB, DELAY, SUBSCRIBE, SUBSCRIBE_SELF, DELETE} from "el/sapa/Event";
...
import PurePathGenerator from "plugins/property-editor/path/PurePathGenerator";
...
export default class PathEditor extends PathCutter {
    ...
    convertPathToArea(obj) {
        ...
        this.pathParser.reset(obj.d).scaleFunc(this.state.domainScale, this.state.rangeScale);
    }
