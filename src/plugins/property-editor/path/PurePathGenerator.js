import SegmentManager from "el/editor/parser/SegmentManager";
...
export default class PurePathGenerator {
    ...
    moveSegment(segmentKey, dx, dy, originSegment = undefined, maxWidth = undefined, maxHeight = undefined) {
    ...
    move(dx, dy, e, maxWidth, maxHeight) {
        ...
        if (this.selectedPointList.length > 1) {
            ...
            if (isCurveSegment) {
                ...
                } else if (e.shiftKey) {    // Curve 만 움직이기 
                    this.moveSegment(segmentKey, dx, dy);
                } else {
                    // 해당 segment 먼저 움직이고                 
