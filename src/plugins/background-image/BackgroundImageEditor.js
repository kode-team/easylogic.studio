...
export default class BackgroundImageEditor extends EditorElement {
        ...
        "drag_indicator"
                ...
                <div class='fill-info'>
                  <div class='gradient-info'>
                    ...
                    <div class='tools'>
                      <button type="button" class='visibility' data-index='${index}' title="Visibility">${iconUse(
        it.visibility === VisibilityType.HIDDEN ? "visible_off" : "visible"
      )}</button>
                    </div>                                       
                    <div class='tools'>
                      <button type="button" class='copy' data-index='${index}' title="Copy Item">${iconUse(
        "add"
      )}</button>
                    </div>                    
                    <div class='tools'>
                      <button type="button" class='remove' data-index='${index}' title="Remove Item">${iconUse(
        "remove2"
      )}</button>
                    </div>
                  </div>
  ...
  [CLICK("$fillList .tools .visibility")](e) {
    ...
    // visibility
    this.state.images[index].visibility =
      this.state.images[index].visibility === VisibilityType.HIDDEN
