import { DRAGOVER, DROP, PREVENT, TRANSITIONEND, POINTERSTART, MOVE, BIND, THROTTLE, SUBSCRIBE, END, CONFIG } from "el/base/Event";
  ...
  template() {
    return /*html*/`
      <div class="designeditor">
        <div class="elf--embed-layout-main">
          <div class='layout-top' ref='$top'>
            
          </div>
          <div class="layout-middle" ref='$middle'>      
            <div class="layout-body" ref='$bodyPanel'>
              <div class="layout-body-toolbar">
