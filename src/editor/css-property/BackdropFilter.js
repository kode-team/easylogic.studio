...
BackdropBlurFilter.spec = { title: 'Blur', inputType: 'range', min: 0, max: 100, step: 1, unit: UNIT_PX, defaultValue: Length.px(0) }
...
BackdropGrayscaleFilter.spec = { title: 'Grayscale', inputType: 'range', min: 0, max: 100, step: 1, unit: UNIT_PERCENT, defaultValue: Length.percent(0) }
...
BackdropHueRotateFilter.spec = { title: 'Hue', inputType: 'range', min: 0, max: 360, step: 1, unit: UNIT_DEG, defaultValue: Length.deg(0) }
...
BackdropInvertFilter.spec = { title: 'Invert', inputType: 'range', min: 0, max: 100, step: 1, unit: UNIT_PERCENT, defaultValue: Length.percent(0) }
...
BackdropBrightnessFilter.spec = { title: 'Brightness', inputType: 'range', min: 0, max: 200, step: 1, unit: UNIT_PERCENT, defaultValue: Length.percent(100) }
...
BackdropContrastFilter.spec = { title: 'Contrast', inputType: 'range', min: 0, max: 200, step: 1, unit: UNIT_PERCENT, defaultValue: Length.percent(100) }
...
BackdropOpacityFilter.spec = { title: 'Opacity', inputType: 'range', min: 0, max: 100, step: 1, unit: UNIT_PERCENT, defaultValue: Length.percent(100) }
...
BackdropSaturateFilter.spec = { title: 'Saturate', inputType: 'range', min: 0, max: 100, step: 1, unit: UNIT_PERCENT, defaultValue: Length.percent(100) }
...
BackdropSepiaFilter.spec = { title: 'Sepia', inputType: 'range', min: 0, max: 100, step: 1, unit: UNIT_PERCENT, defaultValue: Length.percent(0) }
