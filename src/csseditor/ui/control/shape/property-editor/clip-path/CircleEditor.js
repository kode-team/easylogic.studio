...
export default class CircleEditor extends UIElement {
    ...
    template() {
        ...
        <div class='clip-path-editor circle-editor'>
            <RangeEditor ref='$range' label='Radius' key='radius' value='${this.state.radius}' selectedUnit='${this.state.radius.unit}' min="0" max="100" step="0.1" units="%,closest-side,farthest-side" onchange='changeRangeEditor' />
