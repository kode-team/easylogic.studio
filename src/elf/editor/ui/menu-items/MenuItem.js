  ...
  template() {
    return /*html*/ `
        <button 
            ...
            ${
              this.isHideTitle() && this.isHideTooltip() === false
        ...
        >
            <div class="icon ${this.getIcon()}" ref="$icon">${
      icon[this.getIconString()] || this.getIconString() || ""
    }</div>
            ${
              this.isHideTitle()
                ? ""
                : /*html*/ `<div class="title">${this.getTitle()}</div>`
            }
