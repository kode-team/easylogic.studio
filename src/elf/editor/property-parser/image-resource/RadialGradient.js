...
export class RadialGradient extends Gradient {
  ...
  toCloneObject() {
    return {
      ...super.toCloneObject(),
      ...this.attrs("radialType", "radialSize", "radialPosition"),
    };
  }
  ...
  getConerDist(result) {
    ...
    const bottomLeftDist = vec3.dist(
      result.radialCenterPosition,
      bottomLeftPoint
    );
    const bottomRightDist = vec3.dist(
      result.radialCenterPosition,
      bottomRightPoint
    );
      ...
      case RadialGradientType.CIRCLE:
        switch (radialSize) {
          ...
          case RadialGradientSizeType.FARTHEST_CORNER:
            var [, , dist] = cornerList[cornerList.length - 1];
            endPoint = vec3.fromValues(
              startPoint[0] + dist,
              startPoint[1],
              startPoint[2]
          ...
          default:
            ...
            var dist = (radialSize[0] || radialSize).toPx(
              vec3.dist(result.backVerties[1], result.backVerties[0])
            ).value;
            endPoint = vec3.fromValues(
              startPoint[0] + dist,
              startPoint[1],
      ...
      case RadialGradientType.ELLIPSE:
        switch (radialSize) {
          case RadialGradientSizeType.CLOSEST_SIDE:
            ...
            endPoint = vec3.fromValues(
              startPoint[0] + newSize.width,
              startPoint[1],
              startPoint[2]
            );
            shapePoint = vec3.fromValues(
              startPoint[0],
              startPoint[1] + newSize.height,
              startPoint[2]
            );
          ...
          case RadialGradientSizeType.CLOSEST_CORNER:
            ...
            endPoint = vec3.fromValues(
              startPoint[0] + radius.width,
              startPoint[1],
              startPoint[2]
            );
            shapePoint = vec3.fromValues(
              startPoint[0],
              startPoint[1] + radius.height,
              startPoint[2]
            );
            break;
          case RadialGradientSizeType.FARTHEST_SIDE:
          ...
          case RadialGradientSizeType.FARTHEST_CORNER:
            ...
            break;
          default:
            var raySize = radialSize[0].toPx(
              vec3.dist(result.backVerties[1], result.backVerties[0])
            ).value;
            var shapeSize = radialSize[1].toPx(
              vec3.dist(result.backVerties[3], result.backVerties[0])
            ).value;

            endPoint = vec3.fromValues(
              startPoint[0] + raySize,
              startPoint[1],
              startPoint[2]
            );
            shapePoint = vec3.fromValues(
              startPoint[0],
              startPoint[1] + shapeSize,
              startPoint[2]
            );
            break;
        }
  ...
  toString() {
    ...
    opt = radialPosition
      ? `${radialType} ${radialSize} at ${radialPosition}`
      : `${radialType} ${radialSize}`;
