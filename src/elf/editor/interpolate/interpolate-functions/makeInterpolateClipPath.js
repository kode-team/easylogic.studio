  ...
  if (startObject.type == endObject.type && startObject != "none") {
    switch (startObject.type) {
      case "circle":
        ...
        obj.value = makeInterpolateClipPathCircle(
          layer,
          property,
          startObject.value,
          endObject.value
      ...
      case "ellipse":
        ...
        obj.value = makeInterpolateClipPathEllipse(
          layer,
          property,
          startObject.value,
          endObject.value
      ...
      case "inset": // 구현 해야함
        ...
        obj.value = makeInterpolateClipPathInset(
          layer,
          property,
          startObject.value,
          endObject.value
      ...
      case "polygon": // 구현 해야함
        ...
        obj.value = makeInterpolateClipPathPolygon(
          layer,
          property,
          startObject.value,
          endObject.value
      ...
      case "path": // 구현 해야함
        ...
        // obj.value = makeInterpolateClipPathPath(
        //   layer,
        //   property,
        //   startObject.value,
        //   endObject.value
