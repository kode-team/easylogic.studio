...
export function makeInterpolateColorStep(
  layer,
  property,
  startColorStep,
  endColorStep
  ...
  var obj = {
    cut: makeInterpolateBoolean(
      layer,
      property,
      startColorStep.cut,
      endColorStep.cut
    ),
    percent: makeInterpolateNumber(
      layer,
      property,
      startColorStep.percent,
      endColorStep.percent
    ),
    px: makeInterpolateNumber(
      layer,
      property,
      startColorStep.px,
      endColorStep.px
    ),
    em: makeInterpolateNumber(
      layer,
      property,
      startColorStep.em,
      endColorStep.em
    ),
    unit: makeInterpolateString(
      layer,
      property,
      startColorStep.unit,
      endColorStep.unit
