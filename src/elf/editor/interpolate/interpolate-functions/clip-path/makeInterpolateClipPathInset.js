...
export function makeInterpolateClipPathInset(layer, property, s, e) {
  var obj = {
    ...
    topRadius: makeInterpolateNumber(
      layer,
      property,
      s.topRadius.value,
      e.topRadius.value,
    ...
    leftRadius: makeInterpolateNumber(
      layer,
      property,
      s.leftRadius.value,
      e.leftRadius.value,
    ...
    rightRadius: makeInterpolateNumber(
      layer,
      property,
      s.rightRadius.value,
      e.rightRadius.value,
    ...
    bottomRadius: makeInterpolateNumber(
      layer,
      property,
      s.bottomRadius.value,
      e.bottomRadius.value,
      s.bottomRadius.unit
    ),
  };
  ...
  return (rate, t) => {
    ...
    var results = `${position} ${
      round && radius.trim() ? `round ${radius}` : ""
    }`;
