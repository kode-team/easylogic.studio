...
export function makeInterpolateFilterItem(
  ...
  var obj = {
    type: makeInterpolateString(
      layer,
      property,
      startValue.type,
      endValue.type
    ),
    value: makeInterpolateBoolean(
      layer,
      property,
      startValue.value,
      endValue.value
  ...
  switch (startValue.type) {
    case "blur":
      obj.value = makeInterpolateLength(
        layer,
        property,
        startValue.value,
        endValue.value
    ...
    case "sepia":
    case "hue-rotate":
      obj.value = makeInterpolateNumber(
        layer,
        property,
        startValue.value.value,
        endValue.value.value,
        startValue.value.unit
      );
      break;
    case "drop-shadow":
      obj.offsetX = makeInterpolateLength(
        layer,
        property,
        startValue.offsetX,
        endValue.offsetX,
      ...
      obj.offsetY = makeInterpolateLength(
        layer,
        property,
        startValue.offsetY,
        endValue.offsetY,
      ...
      obj.blurRadius = makeInterpolateLength(
        layer,
        property,
      ...
      obj.spreadRadius = makeInterpolateLength(
        layer,
        property,
        startValue.spreadRadius,
        endValue.spreadRadius,
        "width",
        "self"
      );
      obj.color = makeInterpolateColor(
        layer,
        property,
        startValue.color,
        endValue.color
