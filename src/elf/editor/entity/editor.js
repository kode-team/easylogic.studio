import { booleanValue, Entity, entityList, Enum, enumValue, stringList, stringMap, stringValue } from "@entityjs/entityjs";
import { MenuItemType } from "../types/editor";


export const MenuItemTypeEnum = new Enum(MenuItemType.DROPDOWN, MenuItemType.BUTTON, MenuItemType.LINK);
